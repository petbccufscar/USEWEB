...
newMomentProto.stripTime = function() {
	...
	if (!this._ambigTime) {
		...
		//  use keepLocalTime in the future
...
//  look into Moment's keepLocalTime functionality
...
//  look into moment.momentProperties for this.
...
function mixIntoClass(theClass, members) {
	copyOwnProps(members, theClass.prototype); //  copyNativeMethods?
}
;;
		...
		var dragListener = this.segResizeListener = new HitDragListener(this, {
			...
			hitOver: function(hit, isOrig, origHit) {
				...
				if (resizeLocation) {
					...
					// no change? ( how does this work with timezones?)
...
//  best place for this? related to lang?
